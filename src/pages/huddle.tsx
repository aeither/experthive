  ...
  return (
    <div className="grid grid-cols-2">
      <div>
        ...
        <h2 className="text-3xl font-extrabold text-blue-500">Idle</h2>
        <input
          type="text"
        ...
        <br />
        <br />
        <h2 className="text-3xl font-extrabold text-red-500">Initialized</h2>
        <input
          type="text"
        ...
        <br />
        <br />
        <h2 className="text-3xl font-extrabold text-yellow-500">Lobby</h2>
        ...
        <br />
        <h2 className="text-3xl font-extrabold text-green-600">Room</h2>
        <div className="flex flex-wrap gap-4">
          <Button
